<%@ Page Title="Срабатывания датчиков затопления" Language="C#" MasterPageFile="~/MasterPages/DataPage.master" 
    AutoEventWireup="true" CodeBehind="WaterSensorEvents.aspx.cs" Inherits="Horizont.Web.WaterSensorEvents" %>
...
<asp:Content ID="HeadContentId" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            initWaterSensorEvents();
        });
    </script>
</asp:Content>

<asp:Content ID="HeaderContent" ContentPlaceHolderID="HeaderContent" runat="server">
    <h1 ID="data_table_title">ОТЧЕТ О СРАБАТЫВАНИИ ДАТЧИКОВ ЗАТОПЛЕНИЯ</h1>
</asp:Content>
