<%@ Page Title="Срабатывания датчиков загазованности" Language="C#" MasterPageFile="~/MasterPages/DataPage.master" 
    AutoEventWireup="true" CodeBehind="GasSensorEvents.aspx.cs" Inherits="Horizont.Web.GasSensorEvents" %>
...
<asp:Content ID="HeaderContent" ContentPlaceHolderID="HeaderContent" runat="server">
    <h1 ID="data_table_title">ОТЧЕТ О СРАБАТЫВАНИИ ДАТЧИКОВ ЗАГАЗОВАННОСТИ</h1>
</asp:Content>
