<%@ Page Title="Заявки по лифтам" Language="C#" MasterPageFile="~/MasterPages/LiftClaims.master" AutoEventWireup="true" 
    CodeBehind="LiftClaims.aspx.cs" Inherits="Horizont.Web.LiftClaims" %>
...
<asp:Content ID="HeaderContent" ContentPlaceHolderID="HeaderContent" runat="server">
    <h1 ID="data_table_title">ПЕРЕЧЕНЬ ЗАЯВОК ПО ЛИФТАМ</h1>
</asp:Content>
