<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CommonClaimControl.ascx.cs" Inherits="HorizontSite.CommonClaimControl" %>
<div id="common_claim_control" class="cc-control">
    <div class="cc-header">
    ...
    <div class="cc-validators">
        <asp:CustomValidator ID="CustomValidator1" runat="server" Text="*" CssClass="common-claim-validator" 
            ...
            SetFocusOnError="True" OnServerValidate="SubmissionCheck" ClientValidationFunction="submissionCheck">
            </asp:CustomValidator>
