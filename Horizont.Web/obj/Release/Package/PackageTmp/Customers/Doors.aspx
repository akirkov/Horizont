<%@ Page Title="Двери" Language="C#" MasterPageFile="~/MasterPages/DataPage.master" AutoEventWireup="true" 
    CodeBehind="Doors.aspx.cs" Inherits="Horizont.Web.Doors" %>
...
<asp:Content ID="HeaderContent" ContentPlaceHolderID="HeaderContent" runat="server">
    <h1 ID="data_table_title">ДВЕРИ</h1>
</asp:Content>
<asp:Content ID="FilterContent" ContentPlaceHolderID="FilterContent" runat="server">
    <div class="elv-objects-filter">
        ...
        <input type="radio" name="elv-objects-filter" value="1" checked="checked" />Вскрытые
    </div>
</asp:Content>
