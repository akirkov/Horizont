<%@ Page Title="Простои лифтов" Language="C#" MasterPageFile="~/MasterPages/DataPage.master" AutoEventWireup="true" 
    CodeBehind="LiftEvents.aspx.cs" Inherits="Horizont.Web.LiftEvents" %>
...
<asp:Content ID="HeaderContent" ContentPlaceHolderID="HeaderContent" runat="server">
    <h1 ID="data_table_title">ОТЧЕТ О ПРОСТОЯХ ЛИФТОВ</h1>
</asp:Content>
