<%@ Page Title="Срабатывания пожарных датчиков" Language="C#" MasterPageFile="~/MasterPages/DataPage.master" 
    AutoEventWireup="true" CodeBehind="FireSensorEvents.aspx.cs" Inherits="Horizont.Web.FireSensorEvents" %>
...
<asp:Content ID="HeadContentId" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            initFireSensorEvents();
        });
    </script>
</asp:Content>

<asp:Content ID="HeaderContent" ContentPlaceHolderID="HeaderContent" runat="server">
    <h1 ID="data_table_title">ОТЧЕТ О СРАБАТЫВАНИИ ПОЖАРНЫХ ДАТЧИКОВ</h1>
</asp:Content>
