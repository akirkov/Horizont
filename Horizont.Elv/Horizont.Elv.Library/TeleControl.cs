...
namespace Horizont.Elv.Model
{
    ...
    [KnownType(typeof(TeleControlState))]
    public partial class TeleControl: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private TeleControlState _state;
        ...
        private void FixupState(TeleControlState previousValue)
        {
