...
namespace Horizont.Elv.Model
{
    ...
    public partial class FireSensorState: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public int FireSensorId
        {
            ...
            set
            {
                if (_fireSensorId != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("Свойство FireSensorId является частью ключа объекта, поэтому его нельзя изменить. Ключевые свойства можно изменять только в тех случаях, когда объект не отслеживается или находится в состоянии добавления.");
                    }
                    _fireSensorId = value;
