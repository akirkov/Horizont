namespace Horizont.Elv.Library.Entities
{
    ...
    public class WaterSensorObject
    {
        public WaterSensorObject() { }
        public WaterSensorObject(WaterSensor obj)
        {
            CopyFrom(obj);
        }
        ...
        public void CopyFrom(WaterSensor obj)
        {
            if (obj == null)
                return;
        ...
        public void CopyTo(ref WaterSensor obj)
        {
            if (obj == null)
                obj = new WaterSensor();
            if (obj.State == null)
                obj.State = new WaterSensorState();
