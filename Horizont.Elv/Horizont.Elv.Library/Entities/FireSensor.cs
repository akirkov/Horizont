namespace Horizont.Elv.Library.Entities
{
    ...
    public class FireSensorObject
    {
        public FireSensorObject() { }
        public FireSensorObject(FireSensor obj)
        {
            CopyFrom(obj);
        }
        ...
        public void CopyFrom(FireSensor obj)
        {
            if (obj == null)
                return;
        ...
        public void CopyTo(ref FireSensor obj)
        {
            if (obj == null)
                obj = new FireSensor();
            if (obj.State == null)
                obj.State = new FireSensorState();
