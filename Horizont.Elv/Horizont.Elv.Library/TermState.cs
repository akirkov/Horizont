...
namespace Horizont.Elv.Model
{
    ...
    public partial class TermState: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public int TermId
        {
            ...
            set
            {
                if (_termId != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("Свойство TermId является частью ключа объекта, поэтому его нельзя изменить. Ключевые свойства можно изменять только в тех случаях, когда объект не отслеживается или находится в состоянии добавления.");
                    }
                    _termId = value;
