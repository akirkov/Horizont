...
namespace Horizont.Elv.Model
{
    ...
    public partial class DoorState: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public int DoorId
        {
            ...
            set
            {
                if (_doorId != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("Свойство DoorId является частью ключа объекта, поэтому его нельзя изменить. Ключевые свойства можно изменять только в тех случаях, когда объект не отслеживается или находится в состоянии добавления.");
                    }
                    _doorId = value;
