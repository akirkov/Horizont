...
namespace Horizont.Elv.Model
{
    ...
    [KnownType(typeof(LiftEvent))]
    [KnownType(typeof(Term))]
    [KnownType(typeof(LiftState))]
    public partial class Lift: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public TrackableCollection<LiftEvent> Events
        {
            get
            {
                if (_events == null)
                {
                    _events = new TrackableCollection<LiftEvent>();
            ...
            set
            {
                if (!ReferenceEquals(_events, value))
                {
                    ...
                    if (_events != null)
                    {
                        ...
                        foreach (LiftEvent item in _events)
                        {
        ...
        private TrackableCollection<LiftEvent> _events;
        ...
        private void FixupState(LiftState previousValue)
        {
            // Это основной конец в ассоциации, выполняющей каскадные удаления.
        ...
        private void FixupEvents(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.NewItems != null)
            {
                foreach (LiftEvent item in e.NewItems)
                {
                    item.Lift = this;
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
            ...
            if (e.OldItems != null)
            {
                foreach (LiftEvent item in e.OldItems)
                {
                    if (ReferenceEquals(item.Lift, this))
                    {
                        item.Lift = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
