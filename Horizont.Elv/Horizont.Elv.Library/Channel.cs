...
namespace Horizont.Elv.Model
{
    ...
    [KnownType(typeof(ChannelEvent))]
    [KnownType(typeof(Term))]
    [KnownType(typeof(ChannelState))]
    public partial class Channel: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public Nullable<int> NormalLevel
        {
            ...
            set
            {
                ...
                {
                    _normalLevel = value;
                    OnPropertyChanged("NormalLevel");
                }
            }
        }
        private Nullable<int> _normalLevel;
        ...
        [DataMember]
        public TrackableCollection<ChannelEvent> Events
        {
            get
            {
                if (_events == null)
                {
                    _events = new TrackableCollection<ChannelEvent>();
        ...
        private TrackableCollection<ChannelEvent> _events;
        ...
        private void FixupState(ChannelState previousValue)
        {
        ...
        private void FixupEvents(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.NewItems != null)
            {
                foreach (ChannelEvent item in e.NewItems)
                {
                    item.Channel = this;
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
            ...
            if (e.OldItems != null)
            {
                foreach (ChannelEvent item in e.OldItems)
                {
