...
namespace Horizont.Elv.Model
{
    ...
    [KnownType(typeof(WaterSensorEvent))]
    [KnownType(typeof(WaterSensorState))]
    public partial class WaterSensor: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public TrackableCollection<WaterSensorEvent> Events
        {
            get
            {
                if (_events == null)
                {
                    _events = new TrackableCollection<WaterSensorEvent>();
        ...
        private TrackableCollection<WaterSensorEvent> _events;
    
        [DataMember]
        public WaterSensorState State
        {
            get { return _state; }
            set
            {
        ...
        private WaterSensorState _state;
        ...
        private void FixupState(WaterSensorState previousValue)
        {
        ...
        private void FixupEvents(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.NewItems != null)
            {
                foreach (WaterSensorEvent item in e.NewItems)
                {
                    item.WaterSensor = this;
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
            ...
            if (e.OldItems != null)
            {
                foreach (WaterSensorEvent item in e.OldItems)
                {
                    if (ReferenceEquals(item.WaterSensor, this))
                    {
                        item.WaterSensor = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
