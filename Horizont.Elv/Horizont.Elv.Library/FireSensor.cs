...
namespace Horizont.Elv.Model
{
    ...
    [KnownType(typeof(FireSensorEvent))]
    [KnownType(typeof(Term))]
    [KnownType(typeof(FireSensorState))]
    public partial class FireSensor: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public TrackableCollection<FireSensorEvent> Events
        {
            get
            {
                if (_events == null)
                {
                    _events = new TrackableCollection<FireSensorEvent>();
        ...
        private TrackableCollection<FireSensorEvent> _events;
        ...
        private FireSensorState _state;
        ...
        private void FixupState(FireSensorState previousValue)
        {
        ...
        private void FixupEvents(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.NewItems != null)
            {
                foreach (FireSensorEvent item in e.NewItems)
                {
                    item.FireSensor = this;
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
            ...
            if (e.OldItems != null)
            {
                foreach (FireSensorEvent item in e.OldItems)
                {
                    if (ReferenceEquals(item.FireSensor, this))
                    {
                        item.FireSensor = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
