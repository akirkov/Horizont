...
namespace Horizont.Claims.Model
{
    ...
    public partial class CommonClaim: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public Nullable<System.DateTime> SentTime
        {
        ...
        private Nullable<System.DateTime> _sentTime;
    
        [DataMember]
        public Nullable<System.DateTime> DeliveredTime
        {
            ...
            set
            {
                if (_deliveredTime != value)
                {
                    ...
                    OnPropertyChanged("DeliveredTime");
                }
            }
        }
        private Nullable<System.DateTime> _deliveredTime;
    
        [DataMember]
        public string DeliveredOperator
        {
            get { return _deliveredOperator; }
            set
            {
                if (_deliveredOperator != value)
                {
                    _deliveredOperator = value;
                    OnPropertyChanged("DeliveredOperator");
                }
            }
        }
        private string _deliveredOperator;
        ...
        private void FixupAddress(Address previousValue, bool skipKeys = false)
        {
            ...
            if (previousValue != null && previousValue.CommonClaims.Contains(this))
            {
                previousValue.CommonClaims.Remove(this);
            }
    
            if (Address != null)
            {
                if (!Address.CommonClaims.Contains(this))
                {
                    Address.CommonClaims.Add(this);
                }
        ...
        private void FixupCommonFailure(CommonFailure previousValue, bool skipKeys = false)
        {
            ...
            {
                if (!CommonFailure.CommonClaims.Contains(this))
                {
                    CommonFailure.CommonClaims.Add(this);
                }
        ...
        private void FixupDisp(Disp previousValue, bool skipKeys = false)
        {
            ...
            if (Disp != null)
            {
                if (!Disp.CommonClaims.Contains(this))
                {
                    Disp.CommonClaims.Add(this);
                }
        ...
        private void FixupJournal(Journal previousValue, bool skipKeys = false)
        {
            ...
            if (Journal != null)
            {
                if (!Journal.CommonClaims.Contains(this))
                {
                    Journal.CommonClaims.Add(this);
                }
