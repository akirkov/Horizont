...
namespace Horizont.Claims.Model
{
    ...
    public partial class LiftClaim: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public Nullable<int> OtisId
        {
            ...
            set
            {
                ...
                {
                    _otisId = value;
                    OnPropertyChanged("OtisId");
                }
            }
        }
        private Nullable<int> _otisId;
        ...
        private void FixupAddress(Address previousValue, bool skipKeys = false)
        {
            ...
            if (previousValue != null && previousValue.LiftClaims.Contains(this))
            {
                previousValue.LiftClaims.Remove(this);
            }
    
            if (Address != null)
            {
                if (!Address.LiftClaims.Contains(this))
                {
                    Address.LiftClaims.Add(this);
                }
        ...
        private void FixupDisp(Disp previousValue, bool skipKeys = false)
        {
            ...
            if (Disp != null)
            {
                if (!Disp.LiftClaims.Contains(this))
                {
                    Disp.LiftClaims.Add(this);
                }
